...
const events = {
  ...
  // April
  '2026-04-01': [{ name: 'Craft',   type: 'program' }, { name: 'Cubby Clean',   type: 'program' }, { name: 'Perogy Day',   type: 'program' }],
  '2026-04-02': [{ name: 'World Autism Day',   type: 'awareness' }, { name: 'Skate',   type: 'program' }],
  '2026-04-03': [{ name: 'Good Friday',        type: 'holiday' }, { name: 'CLOSED',   type: 'program' }],
  '2026-04-05': [{ name: 'Easter Sunday',      type: 'holiday' }],
  '2026-04-06': [{ name: 'Easter Monday',      type: 'holiday' }, { name: 'CLOSED',   type: 'program' }],
  '2026-04-07': [{ name: 'World Health Day',   type: 'awareness' }, { name: 'Friends in Motion',   type: 'program' }],
  '2026-04-08': [{ name: 'Summerland Ornamental Garden Lunch & Games',   type: 'program' }],
  '2026-04-09': [{ name: 'Skate',   type: 'program' }, { name: 'Just for Fun Games',   type: 'program' }],
  '2026-04-10': [{ name: 'Friends in Music',   type: 'program' }, { name: 'Bowling',   type: 'program' }],
  '2026-04-13': [{ name: 'Social Skills Presentation',   type: 'program' }, { name: 'Gym/Swim',   type: 'program' }],
  '2026-04-14': [{ name: 'Vaisakhi',           type: 'cultural' }, { name: 'Friends in Motion',   type: 'program' }, { name: 'Yoga & Lunch',   type: 'program' }],
  '2026-04-15': [{ name: 'Library Craft',   type: 'program' }, { name: 'Cubby Clean',   type: 'program' }],
  '2026-04-16': [{ name: 'Skate',   type: 'program' }, { name: 'Client Meeting',   type: 'program' }],
  '2026-04-17': [{ name: 'Friends in Music',   type: 'program' }, { name: 'Bowling',   type: 'program' }],
  '2026-04-20': [{ name: 'Group Office Clean',   type: 'program' }, { name: 'Gym/Swim',   type: 'program' }],
  '2026-04-21': [{ name: 'Friends in Motion',   type: 'program' }, { name: 'Client Calendars',   type: 'program' }, { name: 'Goal Review',   type: 'program' }, { name: 'SOEC Walk',   type: 'program' }],
  '2026-04-22': [{ name: 'Craft',   type: 'program' }, { name: 'Earth Day',   type: 'awareness' }, { name: 'Scavenger Hunt',   type: 'program' }],
  '2026-04-23': [{ name: 'Skate',   type: 'program' }, { name: 'Japanese Garden',   type: 'program' }, { name: 'Snack & Games',   type: 'program' }],
  '2026-04-24': [{ name: 'Friends in Music',   type: 'program' }, { name: 'Bowling',   type: 'program' }],
  '2026-04-27': [{ name: 'Group Office Clean',   type: 'program' }, { name: 'Gym/Swim',   type: 'program' }],
  '2026-04-28': [{ name: 'Friends in Motion',   type: 'program' }, { name: 'Just for Fun Games',   type: 'program' }],
  '2026-04-29': [{ name: 'Craft',   type: 'program' }, { name: 'International Dance Day',   type: 'awareness' }, { name: 'Soup Day',   type: 'program' }],
  '2026-04-30': [{ name: 'Group walk to see Alice the dinosaur',   type: 'program' }],
  
  // May
  '2026-05-01': [{ name: 'Friends in Music',   type: 'program' }, { name: 'Bowling',   type: 'program' }],
  '2026-05-04': [{ name: 'Group Office Clean',   type: 'program' }, { name: 'Gym/Swim',   type: 'program' }],
  '2026-05-05': [{ name: 'Friends in Motion',   type: 'program' }, { name: 'MMIWG - Wear Red',   type: 'awareness' }],
  '2026-05-06': [{ name: 'Summerland Ornamental Garden - Lunch, Games + Craft',   type: 'program' }],
  '2026-05-07': [{ name: 'Just For Fun - Games',   type: 'program' }, { name: 'Okanagan Lake Walk',   type: 'program' }],
  '2026-05-08': [{ name: 'Friends in Music',   type: 'program' }, { name: 'Bowling',   type: 'program' }],
  '2026-05-10': [{ name: "Mother's Day",       type: 'holiday' }],
  '2026-05-11': [{ name: 'Group Office Clean',   type: 'program' }, { name: 'Gym/Swim',   type: 'program' }],
  ...
  '2026-05-20': [{ name: 'Craft at the Park', type: 'program' }, { name: 'Lunch and Games at Okanagan Beach', type: 'program' }],
  '2026-05-21': [{ name: 'Japanese Garden Snack and Games', type: 'program' }, { name: 'Okanagan Lake Walk', type: 'program' }],
  '2026-05-22': [{ name: 'Friends in Music', type: 'program' }, { name: 'BBQ', type: 'program' }, { name: 'Bowling', type: 'program' }],
  '2026-05-25': [{ name: 'Group Office Clean', type: 'program' }, { name: 'Gym/Swim', type: 'program' }],
  '2026-05-26': [{ name: 'Friends in Motion', type: 'program' }, { name: 'Just for Fun - Games', type: 'program' }],
  '2026-05-27': [{ name: 'Craft at the Park', type: 'program' }, { name: 'Goal Review', type: 'program' }],
  '2026-05-28': [{ name: 'Goat Farm', type: 'program' }, { name: 'Client Calendars', type: 'program' }],
  '2026-05-29': [{ name: 'Friends in Music', type: 'program' }, { name: 'Bowling', type: 'program' }],
  '2026-05-31': [{ name: 'National AccessAbility Week', type: 'awareness' }],
  // June
  '2026-06-01': [{ name: 'National AccessAbility Week', type: 'awareness' }, { name: 'Group Office Clean', type: 'program' }, { name: 'Gym/Swim', type: 'program' }],
  '2026-06-02': [{ name: 'National AccessAbility Week', type: 'awareness' }, { name: 'Friends in Motion', type: 'program' }, { name: 'Games at the Park', type: 'program' }],
  '2026-06-03': [{ name: 'National AccessAbility Week', type: 'awareness' }, { name: 'Red Shirt Day',      type: 'awareness' }],
  '2026-06-04': [{ name: 'National AccessAbility Week', type: 'awareness' }, { name: 'OK Lake Walk', type: 'program' }, { name: 'Just for Fun Games', type: 'program' }],
  '2026-06-05': [{ name: 'National AccessAbility Week', type: 'awareness' }, { name: 'Friends in Music', type: 'program' }, { name: 'Bowling', type: 'program' }],
  '2026-06-06': [{ name: 'National AccessAbility Week', type: 'awareness' }],
  '2026-06-08': [{ name: 'Group Office Clean', type: 'program' }, { name: 'Gym/Swim', type: 'program' }],
  '2026-06-09': [{ name: 'Friends in Motion', type: 'program' }, { name: 'Yoga & Lunch at OK Lake', type: 'program' }],
  '2026-06-10': [{ name: 'Library Craft', type: 'program' }, { name: 'Cubby Clean', type: 'program' }],
  '2026-06-11': [{ name: 'Client Meeting', type: 'program' }, { name: 'OK Lake Walk', type: 'program' }],
  '2026-06-12': [{ name: 'Friends in Music', type: 'program' }, { name: 'Bowling', type: 'program' }],
  '2026-06-15': [{ name: 'Group Office Clean', type: 'program' }, { name: 'Gym/Swim', type: 'program' }],
  '2026-06-16': [{ name: 'Summerland Market', type: 'program' }, { name: 'Friends in Motion', type: 'program' }],
  '2026-06-17': [{ name: 'Craft, Games, & Lunch at the Park', type: 'program' }],
  '2026-06-18': [{ name: 'BBQ', type: 'program' }, { name: 'Graduation Celebration', type: 'program' }],
  '2026-06-19': [{ name: 'Friends in Music', type: 'program' }, { name: 'Bowling', type: 'program' }],
  '2026-06-21': [{ name: 'National Indigenous Peoples Day', type: 'awareness' }],
  '2026-06-22': [{ name: 'Group Office Clean', type: 'program' }, { name: 'Gym/Swim', type: 'program' }],
  '2026-06-23': [{ name: 'Friends in Motion', type: 'program' }, { name: 'Just for Fun Games', type: 'program' }],
  '2026-06-24': [{ name: 'Inclusive Rhythms', type: 'program' }],
  '2026-06-25': [{ name: 'Calendars', type: 'program' }, { name: 'Goal Review', type: 'program' }, { name: 'Ok Lake Walk', type: 'program' }],
  '2026-06-26': [{ name: 'Friends in Music', type: 'program' }, { name: 'Bowling', type: 'program' }],
  '2026-06-29': [{ name: 'Group Office Clean', type: 'program' }, { name: 'Gym/Swim', type: 'program' }],
  '2026-06-30': [{ name: 'Friends in Motion', type: 'program' }, { name: 'Games at the Park', type: 'program' }],
  // July
