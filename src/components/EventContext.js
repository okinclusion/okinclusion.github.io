...
export const EventProvider = ({ children }) => {
  ...
  const [events] = useState([
    ...
    { id: 6, date:  new Date(2026, 1, 17), title: "Chinese New Year" },
    { id: 7, date:  new Date(2026, 1, 16), title: "Family Day"},
    { id: 8, date:  new Date(2026, 1, 25), title: "Pink Shirt Day" },
    ...
    { id: 37, date: new Date(2026, 2, 17), title: "St. Patrick's Day" },
    ...
    { id: 45, date: new Date(2026, 2, 21), title: "World Down Syndrome Day" },
    ...
    { id: 52, date: new Date(2026, 2, 26), title: "Purple Day for Epilepsy" },
