...
export const EventProvider = ({ children }) => {
  ...
  const [events] = useState([
    ...
    { id: 11, date: new Date(2026, 2, 2), title: "Gym/Swim" },
    { id: 11, date: new Date(2026, 2, 3), title: "Friend in Motion" },
    { id: 11, date: new Date(2026, 2, 3), title: "SOEC Walk" },
    { id: 11, date: new Date(2026, 2, 4), title: "Craft" },
    { id: 11, date: new Date(2026, 2, 4), title: "Art Gallery Tour" },
    { id: 11, date: new Date(2026, 2, 5), title: "H20" },
    { id: 11, date: new Date(2026, 2, 5), title: "Cubby Clean" },
    { id: 11, date: new Date(2026, 2, 6), title: "Friends in Music" },
    { id: 11, date: new Date(2026, 2, 6), title: "Bowling" },
    ...
    { id: 15, date: new Date(2026, 2, 9), title: "Group Office Clean" },
    { id: 15, date: new Date(2026, 2, 9), title: "Gym/Swim" },
    { id: 15, date: new Date(2026, 2, 10), title: "Friends in Motion" },
    { id: 15, date: new Date(2026, 2, 10), title: "SOEC Walk" },
    { id: 15, date: new Date(2026, 2, 11), title: "Library Craft" },
    { id: 15, date: new Date(2026, 2, 11), title: "Cubby Clean" },
    { id: 15, date: new Date(2026, 2, 12), title: "Skating" },
    { id: 15, date: new Date(2026, 2, 12), title: "Client Meeting" },
    { id: 15, date: new Date(2026, 2, 13), title: "Friends in Music" },
    { id: 15, date: new Date(2026, 2, 13), title: "Bowling" },
    { id: 15, date: new Date(2026, 2, 16), title: "Group Office Clean" },
    { id: 15, date: new Date(2026, 2, 16), title: "Gym/Swim" },
    { id: 15, date: new Date(2026, 2, 17), title: "St. Patrick's Day" },
    { id: 15, date: new Date(2026, 2, 17), title: "Craft" },
    { id: 15, date: new Date(2026, 2, 18), title: "Apex Tubing" },
    { id: 15, date: new Date(2026, 2, 19), title: "Skating" },
    { id: 15, date: new Date(2026, 2, 19), title: "Cubby Clean" },
    { id: 15, date: new Date(2026, 2, 19), title: "Goal Review" },
    { id: 15, date: new Date(2026, 2, 20), title: "Crazy Sock Day" },
    { id: 15, date: new Date(2026, 2, 20), title: "Bowling" },
    { id: 16, date: new Date(2026, 2, 21), title: "World Down Syndrome Day" },
    { id: 15, date: new Date(2026, 2, 23), title: "Group Office Clean" },
    { id: 15, date: new Date(2026, 2, 23), title: "Gym/Swim" },
    { id: 15, date: new Date(2026, 2, 24), title: "SOEC Walk" },
    { id: 15, date: new Date(2026, 2, 25), title: "Craft" },
    { id: 15, date: new Date(2026, 2, 25), title: "Calendars" },
    { id: 15, date: new Date(2026, 2, 25), title: "Soup Day" },
    { id: 17, date: new Date(2026, 2, 26), title: "Purple Day for Epilepsy" },
    { id: 15, date: new Date(2026, 2, 26), title: "Skating" },
    { id: 15, date: new Date(2026, 2, 26), title: "Cubby Clean" },
    { id: 15, date: new Date(2026, 2, 26), title: "Scavenger Hunt" },
    { id: 15, date: new Date(2026, 2, 27), title: "Craft" },
    { id: 15, date: new Date(2026, 2, 27), title: "Bowling" },
    { id: 15, date: new Date(2026, 2, 30), title: "Nature Walk" },   
    { id: 18, date: new Date(2026, 2, 31), title: "International Transgender Day of Visibility" },
    { id: 15, date: new Date(2026, 2, 31), title: "Friends in Motion" },
    { id: 15, date: new Date(2026, 2, 31), title: "SOEC Walk" },
    // April
